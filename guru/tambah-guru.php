            ...
            <div class="mobile-header-container lg:hidden" id="mobileHeaderContainer">
                ...
                <header class="main-header mobile-header flex justify-between items-center">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-slate-500 text-xs truncate">Form tambah data guru baru</div>
                    </div>
                </header>
            ...
            <div class="desktop-header-container hidden lg:block">
                ...
                <header class="main-header desktop-header flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-slate-500 mt-1">Formulir untuk menambahkan data guru baru ke sistem</p>
                    </div>
                    ...
                    <div class="card p-6 mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-700">
                            <div class="flex items-start gap-3">
                                <i class="fa-solid fa-user-tie text-green-600 mt-1"></i>
                                <div>
                                    <strong>Hak Akses Guru</strong>
                                    <p class="text-slate-600 mt-1">Guru memiliki akses untuk mengelola kelas, mata pelajaran, jadwal, nilai, dan kehadiran siswa</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
